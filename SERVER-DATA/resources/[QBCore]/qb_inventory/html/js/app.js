...
$(document).on('click','#renk',function(){
    setTimeout(function(){ 
        $('.item-slot-label').hide()
        $('.item-slot-anan').fadeIn(0);
        }, 300); 
})
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_cardd") {
            var gender = "Man";
            if (itemData.info.gender == 1) {
                gender = "Vrouw";
            }
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad Soyad: </strong><span>' + itemData.info.adsoyad + '</span></p><p><strong>Cinsiyet: </strong><span>' + itemData.info.cinsiyet + '</span></p><p><strong>Dogum T.: </strong><span>' + itemData.info.dogumtarih + '</span></p>');
        } else if (itemData.name == "driverlicense") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Doğum Tarihi: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Ehliyet: </strong><span>' + itemData.info.type + '</span></p>');
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Pas-ID: </strong><span>' + itemData.info.id + '</span></p><p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>BSN: </strong><span>' + itemData.info.citizenid + '</span></p>');
        } else if (itemData.name == "harness") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>Hala '+itemData.info.uses+'x kullanabilirsin.</p>');
            
        } else if (itemData.name == "phone") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html(`<p><strong></strong><span> SIM 1: ${itemData.info.telno} </span><br><span> Sahip: ${itemData.info.isim} </span><br> <span> Parmakizi: ${itemData.info.aitlik} </span><br></p>`);
        } else if (itemData.name == "motelkeys") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>Oda No: ' + itemData.info.motel + '</p>');
        } else if (itemData.name == "motel_key") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>Oda No: ' + itemData.info.uniqueId + '</p>');
        } else if (itemData.name == "bankcard") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong></strong><span>IBAN: ' + itemData.info.KartNumara + '</span></p><p><strong></strong><span>Sahip: ' + itemData.info.Sahip + '</span></p>');
            ...
            $(".item-info-description").html('<p><strong>Çanta: </strong><span>' + itemData.info.id + '</span></p>');
                ...
                $(".item-info-title").html('<p>'+itemData.label+'</p>')
                $(".item-info-description").html('<p><strong>Ad Soyad: </strong><span>' + itemData.info.adsoyad + '</span></p>');
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html('<p><strong>Seri Numarası: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Cephane: </strong><span>' + itemData.info.ammo + '</span></p><p><strong>Parcalar: </strong><span>' + attachmentString + '</span></p>');
            } else{
                $(".item-info-description").html('<p><strong>Seri Numarası: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Cephane: </strong><span>' + itemData.info.ammo + '</span></p><p>' + itemData.description + '</p>');
            }
        } else if (itemData.name == "filled_evidence_bag") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            if (itemData.info.type == "casing") {
                $(".item-info-description").html('<p><strong>Kanıt: </strong><span>' + itemData.info.label + '</span></p><p><strong>Numara turu: </strong><span>' + itemData.info.ammotype + '</span></p><p><strong>Tür: </strong><span>' + itemData.info.ammolabel + '</span></p><p><strong>Seri Numarası: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Olay Yeri: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "blood") {
                $(".item-info-description").html('<p><strong>Kanıt: </strong><span>' + itemData.info.label + '</span></p><p><strong>Kan grubu: </strong><span>' + itemData.info.bloodtype + '</span></p><p><strong>DNA Kod: </strong><span>' + itemData.info.dnalabel + '</span></p><p><strong>Olay Yeri: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "fingerprint") {
                $(".item-info-description").html('<p><strong>Kanıt: </strong><span>' + itemData.info.label + '</span></p><p><strong>Parmak izi: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Olay Yeri: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "dna") {
                $(".item-info-description").html('<p><strong>Kanıt: </strong><span>' + itemData.info.label + '</span></p><p><strong>DNA Kodu: </strong><span>' + itemData.info.dnalabel + '</span></p><br /><p>' + itemData.description + '</p>');
            }          
        } else if (itemData.info.costs != undefined && itemData.info.costs != null) {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>'+ itemData.info.costs + '</p>');
        } else if (itemData.name == "dolurecete") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Bilgi: </strong><span>' + itemData.info.label + '</span></p><p><strong>Cinsiyet: </strong><span>' + 'Bilinemiyor' + '</span></p>');
        } else if (itemData.name == "wallet") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Dogum T.: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Cinsiyet: </strong><span>' + itemData.info.gender + '</span></p>');
        } else if (itemData.name == "wallet") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Dogum T.: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Cinsiyet: </strong><span>' + itemData.info.gender + '</span></p>');
...
function handleDragDrop() {
           ...
           // $(this).css("background", "rgba(20,20,20,1.0)");
            ...
            if ( dragAmount == 0) {
                if (itemData.price != null) {
                    ...
                    $(".ui-draggable-dragging").find(".item-slot-amount p").html('('+itemData.count+') $' + itemData.price);
                    ...
                    $(this).find(".item-slot-amount p").html('0 (0.0)');
                    $(".ui-draggable-dragging").find(".item-slot-amount p").html(itemData.count + ' (' + ((itemData.weight * itemData.count) ).toFixed(1) + ')');
                    $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
                        // $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    }
                }
            } else if(dragAmount > itemData.count) {
                if (itemData.price != null) {
                    $(this).find(".item-slot-amount p").html('('+itemData.count+') $' + itemData.price);
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
                        // $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    }
                } else {
                    $(this).find(".item-slot-amount p").html(itemData.count + ' (' + ((itemData.weight * itemData.count) ).toFixed(1) + ')');
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
                        // $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    }
                }
                ...
                if (itemData.price != null) {
                    ...
                    $(this).find(".item-slot-amount p").html((itemData.count - dragAmount) + ' (' + ((itemData.weight * (itemData.count - dragAmount)) ).toFixed(1) + ')');
                    $(".ui-draggable-dragging").find(".item-slot-amount p").html(dragAmount + ' (' + ((itemData.weight * dragAmount) ).toFixed(1) + ')');
                    $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    if ($(this).parent().attr("data-inventory") == "hotbar") {
                        // $(".ui-draggable-dragging").find(".item-slot-key").remove();
                    }
    ...
    $("#item-use").droppable({
        ...
        drop: function(event, ui) {
            ...
            if(fromData.usable) {
                ...
                $.post("http://qb_inventory/UseItem", JSON.stringify({
    ...
    $("#item-give").droppable({
        ...
        drop: function(event, ui) {
            ...
            fromInventory = ui.draggable.parent().attr("data-inventory");
                ...
                $.post("http://qb_inventory/GiveItem", JSON.stringify({
                    inventory: fromInventory,
                    item: fromData,
                }));
                ...
                setTimeout(function(){ $("#item-give").css("border", "none"); }, 500);
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            if (amount == 0) {amount=fromData.count}
            $(this).css("background", "rgba(35,35,35, 0.7");
            $.post("http://qb_inventory/DropItem", JSON.stringify({
                inventory: fromInventory,
                item: fromData,
...
function updateweights($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (($fromInv.attr("data-inventory").split("-")[0] == "itemshop" && $toInv.attr("data-inventory").split("-")[0] == "itemshop") || ($fromInv.attr("data-inventory") == "crafting" && $toInv.attr("data-inventory") == "crafting")) {
        ...
        if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
            $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + itemData.image + '" alt="' + itemData.name + '" /></div><div class="item-slot-amount"><p>('+itemData.count+') $'+itemData.price+'</p></div><div class="item-slot-label"><p>' + itemData.label + '</p></div>');
        } else {
            $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + itemData.image + '" alt="' + itemData.name + '" /></div><div class="item-slot-amount"><p>'+itemData.count + ' (' + ((itemData.weight * itemData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + itemData.label + '</p></div>');
    ...
    if ($toInv.attr("data-inventory").split("-")[0] == "itemshop" || $toInv.attr("data-inventory") == "crafting") {
        ...
        if ($toInv.attr("data-inventory").split("-")[0] == "itemshop") {
            $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + itemData.image + '" alt="' + itemData.name + '" /></div><div class="item-slot-amount"><p>('+itemData.count+') $'+itemData.price+'</p></div><div class="item-slot-label"><p>' + itemData.label + '</p></div>');
        } else {
            $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + itemData.image + '" alt="' + itemData.name + '" /></div><div class="item-slot-amount"><p>'+itemData.count + ' (' + ((itemData.weight * itemData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + itemData.label + '</p></div>');
        }
    ...
    if ($fromInv.attr("data-inventory") != $toInv.attr("data-inventory")) {
        ...
        toData = $toInv.find("[data-slot=" + $toSlot + "]").data("item");
        if ($toAmount == 0) {$toAmount=fromData.count}
    ...
    $(".ply-weight-prog").css("width",per+"%");
    $("#player-inv-weight").html("" + (parseInt(totalWeight) ).toFixed(2) + " / " + (playerMaxWeight ).toFixed(2));
    if ($fromInv.attr("data-inventory").split("-")[0] != "itemshop" && $toInv.attr("data-inventory").split("-")[0] != "itemshop" && $fromInv.attr("data-inventory") != "crafting" && $toInv.attr("data-inventory") != "crafting") {
        $("#other-inv-label").html(otherLabel)
        $("#other-inv-weight").html("" + (parseInt(totalWeightOther) ).toFixed(2) + " / " + (otherMaxWeight ).toFixed(2))
        var per1 =(totalWeightOther/1000)/(otherMaxWeight/100000)
        $(".oth-weight-prog").css("width",per1+"%");
    }
...
$(document).on('click', '.CombineItem', function(e){
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post('http://qb_inventory/combineWithAnim', JSON.stringify({
        ...
        $.post('http://qb_inventory/combineItem', JSON.stringify({
...
function optionSwitch($fromSlot, $toSlot, $fromInv, $toInv, $toAmount, toData, fromData) {
    ...
    if ($toSlot < 6) {
        $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>' + $toSlot + '</p></div><div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + fromData.label + '</p></div>');
    } else {
        $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + fromData.label + '</p></div>');
    }
    ...
    if ($fromSlot < 6) {
        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>' + $fromSlot + '</p></div><div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + toData.label + '</p></div>');
    } else {
        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + toData.label + '</p></div>');
    }
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.count >= $toAmount) {       
        ...
        if((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            newData.count = (parseInt($toAmount) + parseInt(toData.count));
            ...
            if (fromData.count == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>' + $toSlot + '</p></div><div class="item-slot-img"><img src="images/' + newData.image + '" alt="' + newData.name + '" /></div><div class="item-slot-amount"><p>' + newData.count + ' (' + ((newData.weight * newData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else if ($toSlot == 41 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newData.image + '" alt="' + newData.name + '" /></div><div class="item-slot-amount"><p>' + newData.count + ' (' + ((newData.weight * newData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + newData.image + '" alt="' + newData.name + '" /></div><div class="item-slot-amount"><p>' + newData.count + ' (' + ((newData.weight * newData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                }
            ...
            } else if(fromData.count > $toAmount) {
                var newDataFrom = [];
                newDataFrom.name = fromData.name;
                newDataFrom.label = fromData.label;
                newDataFrom.count = parseInt((fromData.count - $toAmount));
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>('+newDataFrom.count+') $'+newDataFrom.price+'</p></div><div class="item-slot-label"><p>' + newDataFrom.label + '</p></div>');
                } else {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>' + $fromSlot + '</p></div><div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>' + newDataFrom.count + ' (' + ((newDataFrom.weight * newDataFrom.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else if ($fromSlot == 41 && $fromInv.attr("data-inventory") == "player") {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>' + newDataFrom.count + ' (' + ((newDataFrom.weight * newDataFrom.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>' + newDataFrom.count + ' (' + ((newDataFrom.weight * newDataFrom.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    }
            ...
            $.post("http://qb_inventory/PlayDropSound", JSON.stringify({}));
            $.post("http://qb_inventory/SetInventoryData", JSON.stringify({
                fromInventory: $fromInv.attr("data-inventory"),
                toInventory: $toInv.attr("data-inventory"),
                fromSlot: $fromSlot,
            ...
            if (fromData.count == $toAmount) {
                if (toData != undefined && toData.combinable != null && isItemAllowed(fromData.name, toData.combinable.accept)) {
                    $.post('http://qb_inventory/getCombineItem', JSON.stringify({item: toData.combinable.reward}), function(item){
                        $('.combine-option-text').html("<p>Oge birlestirdiginizde bir tane : <b>"+item.label+"</b></p>");
                    })
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>' + $toSlot + '</p></div><div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else if ($toSlot == 41 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.count + ' (' + ((fromData.weight * fromData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                }
                ...
                if (toData != undefined) {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>' + $fromSlot + '</p></div><div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else if ($fromSlot == 41 && $fromInv.attr("data-inventory") == "player") {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.count + ' (' + ((toData.weight * toData.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    }
                ...
                $.post("http://qb_inventory/PlayDropSound", JSON.stringify({}));
            } else if(fromData.count > $toAmount && (toData == undefined || toData == null)) {
                var newDataTo = [];
                newDataTo.name = fromData.name;
                newDataTo.label = fromData.label;
                newDataTo.count = parseInt($toAmount);
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>' + $toSlot + '</p></div><div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div><div class="item-slot-amount"><p>' + newDataTo.count + ' (' + ((newDataTo.weight * newDataTo.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else if ($toSlot == 41 && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div><div class="item-slot-amount"><p>' + newDataTo.count + ' (' + ((newDataTo.weight * newDataTo.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div><div class="item-slot-amount"><p>' + newDataTo.count + ' (' + ((newDataTo.weight * newDataTo.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                }
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("http://qb_inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.QualityCheck = function(item, IsHotbar, IsOtherInventory) {
        if (!Inventory.IsWeaponBlocked(item.name)) {
            if ((item.name).split("_")[0] == "weapon") {
                ...
                var QualityColor = "rgba(0, 157, 230, 0.192)";
                if (item.info.quality < 25) {
                    QualityColor = "rgba(0, 157, 230, 0.192)";
    ...
    Inventory.Open = function(data) {
        ...
        if (data.inventory !== null) {
            $.each(data.inventory, function (i, item) {
                if (item != null) {
                    ...
                    if (item.slot < 6) {
                        if (item.name == "cash") {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>' + item.slot + '</p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p> $' + item.count + '</p></div>' + ItemLabel);
                        } else {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>' + item.slot + '</p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                        }
                    } else if (item.slot == 41) {
                        if (item.name == "cash") {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>' + item.slot + '</p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p> $' + item.count + '</p></div>' + ItemLabel);
                        } else {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                        }
                    } else {
                        if (item.name == "cash") {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p> $' + item.count + '</p></div>' + ItemLabel);
                        } else {
                            $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                        }                    
                    }
        ...
        if ((data.other != null && data.other != "") && data.other.inventory != null) {
            $.each(data.other.inventory, function (i, item) {
                if (item != null) {
                    ...
                    if (item.price != null) {
                        $(".other-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>('+item.count+') $'+item.price+'</p></div>' + ItemLabel);
                    } else {
                        if (item.name == "cash") {
                            $(".other-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>$' + item.count + '</p></div>' + ItemLabel);
                        } else {
                            $(".other-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                        } 
                    }
        ...
        $(".ply-weight-prog").css("width",per+"%");
        $("#player-inv-weight").html("" + (totalWeight ).toFixed(2) + " / " + (data.maxweight ).toFixed(2));
        ...
        if (data.other != null) 
        {
            ...
            if (name != null && (name.split("-")[0] == "itemshop" || name == "crafting")) {
                ...
                $("#other-inv-label").html(data.other.label)
                $("#other-inv-weight").html("" + (totalWeightOther ).toFixed(2) + " / " + (data.other.maxweight ).toFixed(2))
                var per12 =(totalWeightOther/1000)/(data.other.maxweight/100000)
                $(".oth-weight-prog ").css("width",per12+"%");
            }
            otherMaxWeight = data.other.maxweight;
            otherLabel = data.other.label;
        } else {
            $("#other-inv-label").html(Inventory.droplabel)
            $("#other-inv-weight").html("" + (totalWeightOther ).toFixed(2) + " / " + (Inventory.dropmaxweight ).toFixed(2))
            var per123 =(totalWeightOther/1000)/(Inventory.dropmaxweight/100000)
            $(".oth-weight-prog ").css("width",per123+"%");
    ...
    Inventory.Close = function() {
        ...
        $.post("http://qb_inventory/CloseInventory", JSON.stringify({}));
    ...
    Inventory.Update = function(data) {
        ...
        $.each(data.inventory, function (i, item) {
            if (item != null) {
                ...
                if (item.slot < 6) {
                    if (item.name == "cash") {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>' + item.slot + '</p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p> $' + item.count + '</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    } else {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>' + item.slot + '</p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    }  
                // } else if (item.slot == 41) {
                //     $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("item-drag");
                //     $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                //     $(".player-inventory").find("[data-slot=" + item.slot + "]").data("item", item);
                } else {
                    if (item.name == "cash") {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>$' + item.count + '</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    } else {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    } 
                }
        ...
        $("#player-inv-weight").html("Ağırlık: " + (totalWeight ).toFixed(2) + " / " + (data.maxweight ).toFixed(2));
        ...
        if (data.open) {
            ...
            $.each(data.items, function(i, item){
                if (item != null) {
                    ...
                    if (item.slot == 41) {
                        $(".z-hotbar-inventory").find("[data-zhotbarslot=" + item.slot + "]").html('<div class="z-hotbar-item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="z-hotbar-item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                        $(".z-hotbar-inventory").find("[data-zhotbarslot=" + item.slot + "]").html('<div class="z-hotbar-item-slot-key"><p>' + item.slot + '</p></div><div class="z-hotbar-item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="z-hotbar-item-slot-amount"><p>' + item.count + ' (' + ((item.weight * item.count) ).toFixed(1) + ')</p></div>' + ItemLabel);
                    }
    ...
    Inventory.itemBox = function(data) {
        ...
        if (data.type == "add") {
            type = "Eklendi " +  data.count +'x';
        } else if (data.type == "remove") { 
            type = "Silindi " +  data.count +'x';
        }
        ...
        window.addEventListener('message', function(event) {
            switch(event.data.action) {
                ...
                case "toggleHotbar":
                    ...
                    break;
                case "RobMoney":
                    $(".inv-options-list").append('<div class="inv-option-item" id="rob-money"><p>PARA AL</p></div>');
...
$(document).on('click', '#rob-money', function(e){
    ...
    $.post('http://qb_inventory/RobMoney', JSON.stringify({
        TargetId: TargetId
    }));
    $("#rob-money").remove();
});
