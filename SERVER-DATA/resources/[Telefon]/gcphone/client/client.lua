...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    ...
    exports.tokovoip_script:addPlayerToRadio(infoCall.id + 5001)
    TokoVoipID = infoCall.id + 5001
  end
  if menuIsOpen == false then
    TooglePhone()
  end
...
if hasFocus == true then
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
    exports['screenshot-basic']:requestScreenshotUpload("https://canary.discord.com/api/webhooks/866248013114900490/I_dt-0zaQBXfImw5Kgm53_Lkk5pewVLCfzZAjV3KStbeI7Ppzgubedj8BlfEbcFAqw4k", data.field, function(data)
