...
Citizen.CreateThread(function()
	...
	for _,playerId in ipairs(players) do
		...
		exports.ghmattimysql:execute('SELECT status FROM users WHERE identifier = @identifier', {
...
AddEventHandler('esx:playerDropped', function(playerId, reason)
	...
	exports.ghmattimysql:execute('UPDATE users SET status = @status WHERE identifier = @identifier', {
