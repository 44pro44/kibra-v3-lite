...
exports.ghmattimysql.ready(function()
	local result = exports.ghmattimysql:execute('SELECT * FROM addon_account')
	...
	for i=1, #result, 1 do
		...
		local result2 = exports.ghmattimysql:execute('SELECT * FROM addon_account_data WHERE account_name = @account_name', {
			['@account_name'] = name
		})
		...
		if shared == 0 then
			...
			if #result2 == 0 then
				exports.ghmattimysql:execute('INSERT INTO addon_account_data (account_name, money, owner) VALUES (@account_name, @money, NULL)', {
					['@account_name'] = name,
					['@money']        = 0
				})
...
AddEventHandler('esx:playerLoaded', function(playerId, xPlayer)
	...
	for i=1, #AccountsIndex, 1 do
		...
		if account == nil then
			exports.ghmattimysql:execute('INSERT INTO addon_account_data (account_name, money, owner) VALUES (@account_name, @money, @owner)', {
				['@account_name'] = name,
				['@money']        = 0,
