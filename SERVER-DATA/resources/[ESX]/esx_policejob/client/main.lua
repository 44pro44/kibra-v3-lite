	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			if Config.Uniforms[job].male then
				...
				exports['mythic_notify']:DoHudText('inform', 'Sana uygun üniforma yok', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
			end
...
function StoreNearbyVehicle(playerCoords)
	...
	if #vehicles > 0 then
		...
		exports['mythic_notify']:DoHudText('inform', 'Yakında araç yok', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
		return
	end
	...
	ESX.TriggerServerCallback('esx_policejob:storeNearbyVehicle', function(storeSuccess, foundNum)
		if storeSuccess then
			...
			exports['mythic_notify']:DoHudText('inform', 'Araç senin değil veya aracı garaja koyabilmek için araçtan inmen gerekli', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
		end
	end, vehiclePlates)
end
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	...
	if found then
		...
		exports['mythic_notify']:DoHudText('inform', 'Çıkarma noktalarını araçlar engelliyor', 2500, { ['background-color'] = '#e03232', ['color'] = '#ffffff' })
		return false
	end
end
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_policejob:buyJobVehicle', function (bought)
					if bought then
						...
						exports['mythic_notify']:DoHudText('inform', 'Araç satın alındı', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
						...
						exports['mythic_notify']:DoHudText('inform', 'Aracı almak için yeterli paran yok', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
						menu2.close()
					end
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						if distance <= 2.0 then
							...
							ESX.ShowNotification('Kelepçelemek İçin Çok Uzaksın')
						end
					elseif action == 'uncuff' then
						...
						if distance <= 2.0 then
							...
							--ESX.ShowNotification('Kelepçeyi Çözmek İçin Çok Uzaksın')
						end
					...
					exports['mythic_notify']:DoHudText('inform', 'Yakında oyuncu yok', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
				end
			end, function(data2, menu2)
				menu2.close()
			end)
				...
				elseif DoesEntityExist(vehicle) then
					...
					elseif action == 'hijack_vehicle' then
						if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 3.0) then
							...
							exports['mythic_notify']:DoHudText('inform', 'Araç kilidi açıldı', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
						end
...
--[[function SendToCommunityService(player)
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'Kamu Hizmeti', {
		title = "Kamu Hizmeti",
	}, function (data2, menu)
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_policejob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			exports['mythic_notify']:DoHudText('inform', 'Lisans iptal edildi', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
		...
		if data.current.hasWeapon then
			...
			ESX.TriggerServerCallback('esx_policejob:buyWeapon', function(bought)
				if bought then
					...
					exports['mythic_notify']:DoHudText('inform', 'Yeterli paran yok', 2500, { ['background-color'] = '#e03232', ['color'] = '#ffffff' })
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					exports['mythic_notify']:DoHudText('inform', 'Geçersiz miktar', 2500, { ['background-color'] = '#e03232', ['color'] = '#ffffff' })
				else
					menu2.close()
					menu.close()
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 38) and currentTask.busy then
			...
			exports['mythic_notify']:DoHudText('inform', 'Araca el koymayı iptal ettin', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
			ESX.ClearTimeout(currentTask.task)
...
AddEventHandler("esx_policejob:lockpick", function()
						...
						if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 3.0) then
							...
							SetVehicleDoorsLockedForAllPlayers(vehicle, false)
							--ESX.ShowNotification(_U('vehicle_unlocked'))
							exports['mythic_notify']:DoHudText('inform', 'Araç kilidi açıldı', 2500, {  })
						end
end)
