Locales['en'] = {
  ...
  ['vehicleshop_confirm'] = 'aracı satın almak istiyormusun ?',
  ...
  -- Death
  ['respawn_available_in'] = 'Canlanmanıza Kalan Süre: ~b~%s dakika %s saniye~s~',
  ['respawn_bleedout_in'] = 'you will bleed out in ~b~%s minutes %s seconds~s~\n',
  ['respawn_bleedout_prompt'] = 'hold [~b~E~s~] to respawn',
  ['respawn_bleedout_fine'] = '[~r~E~w~] basılı tutarak canlanabilirsin ~g~$%s~s~',
